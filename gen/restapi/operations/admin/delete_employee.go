...
type DeleteEmployeeHandlerFunc func(DeleteEmployeeParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn DeleteEmployeeHandlerFunc) Handle(params DeleteEmployeeParams, principal interface{}) middleware.Responder {
...
type DeleteEmployeeHandler interface {
	Handle(DeleteEmployeeParams, interface{}) middleware.Responder
}
